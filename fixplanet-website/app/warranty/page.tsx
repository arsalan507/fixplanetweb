      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <ol>
              <li><strong>Contact Us:</strong> Call +91 8105955009 or email hello@fixplanet.in</li>
            ...
            <ul>
              <li><strong>Phone:</strong> +91 8105955009 (Available 9 AM - 9 PM, 7 days)</li>
              <li><strong>Email:</strong> hello@fixplanet.in</li>
              <li><strong>WhatsApp:</strong> +91 8105955009</li>
