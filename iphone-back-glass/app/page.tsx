...
export default function Home() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      source: 'Google Ads - iPhone Back Glass',
    };
    ...
    setTimeout(() => {
      window.location.href = `https://wa.me/${whatsapp}?text=Hi%20FIXplanet!%20I%20have%20a%20broken%20iPhone%20back%20glass.%20My%20name%20is%20${data.name}%20and%20my%20phone%20is%20${data.phone}`;
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="block lg:hidden">
        ...
        <div className="px-4 pt-8 pb-6">
          <Image
            ...
            alt="iPhone Back Glass Replacement Service in Bangalore"
            width={400}
            height={300}
        ...
        <div className="px-4 pb-8">
          <div id="quote-form" className="bg-white rounded-2xl shadow-2xl p-6 border-t-4 border-primary">
            {!submitted ? (
              <>
                <h3 className="text-xl font-bold text-secondary mb-2">Get Your Back Glass Replaced Today</h3>
        ...
        <div className="px-4 pb-8">
          <h2 className="text-3xl font-bold text-secondary leading-tight mb-6">
            iPhone Back Glass Broken?<br />
            <span className="text-primary">We Replace It Perfectly</span>
          </h2>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex items-start space-x-3">
              ...
              <p className="text-base"><strong>Premium OEM Back Glass</strong> - Original quality guaranteed</p>
            </div>
            <div className="flex items-start space-x-3">
              <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
            ...
            <div className="flex items-start space-x-3">
              ...
              <p className="text-base"><strong>Same-Day Service</strong> - Fast back glass replacement in Bangalore</p>
            </div>
          </div>

          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
            <p className="text-sm font-semibold text-yellow-800">
              🔥 Limited Time: <span className="underline">Free diagnosis worth ₹500</span> with every back glass replacement
            </p>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                  ...
                  <p className="text-gray-600 text-sm">Original quality back glass</p>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-sm opacity-90">Back Glass Replaced</div>
            </div>
            <div>
      ...
      <section className="bg-gradient-to-r from-primary to-secondary py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Get Your iPhone Back Glass Replaced?
          </h2>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div>
              ...
              <p className="text-sm opacity-75">Professional iPhone Back Glass Replacement in Bangalore</p>
            </div>
      ...
      <a
        href={`https://wa.me/${whatsapp}?text=Hi%20FIXplanet!%20I%20have%20a%20broken%20iPhone%20back%20glass`}
