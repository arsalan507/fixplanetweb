...
export default function Home() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      source: 'Google Ads - MacBook Battery',
    };
    ...
    setTimeout(() => {
      window.location.href = `https://wa.me/${whatsapp}?text=Hi%20FIXplanet!%20My%20MacBook%20battery%20is%20not%20charging.%20My%20name%20is%20${data.name}%20and%20my%20phone%20is%20${data.phone}`;
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="block lg:hidden">
        ...
        <div className="px-4 pt-8 pb-6">
          <Image
            ...
            alt="MacBook Battery Replacement Service in Bangalore"
            width={400}
            height={300}
        ...
        <div className="px-4 pb-8">
          <h2 className="text-3xl font-bold text-secondary leading-tight mb-6">
            MacBook Battery Issues?<br />
            <span className="text-primary">Expert Battery Replacement Service</span>
          </h2>
      ...
      <section className="bg-gradient-to-r from-primary to-secondary py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Get Your MacBook Battery Replaced?
          </h2>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div>
              ...
              <p className="text-sm opacity-75">Professional MacBook Battery Replacement in Bangalore</p>
            </div>
      ...
      <a
        href={`https://wa.me/${whatsapp}?text=Hi%20FIXplanet!%20My%20MacBook%20battery%20is%20not%20charging`}
